        ...
        <div className="space-y-8">
          ...
          <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition duration-300">
            ...
            <p className="text-gray-600 leading-relaxed">
              Bytesool provides web development, app development, UI/UX design,
          ...
          <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition duration-300">
            ...
            <p className="text-gray-600 leading-relaxed">
              Project timelines depend on complexity. Small projects may take
              1–2 weeks while larger projects can take several months.
            </p>
          </div>
