...
function About() {
  return (
    <section className="bg-gray-50 min-h-screen">
      ...
      {/* CTA Section */}
      <div className="grid grid-cols-1 py-8 mb-0 max-w-full mx-auto text-center bg-gradient-to-r from-[#8490ff] via-[#9f6df0] to-[#e4479e] text-white text-wrap">
        <h1 className="text-2xl md:text-4xl font-medium leading-tight mb-2">
          Let's work together!
        </h1>
        <p className="text-xl md:2xl font-semibold mb-0">
